...
namespace ImpuestoSociedades
{
    ...
    public class Casilla
    {
        ...
        /// Constructor.
        /// </summary>
        /// <param name="identificador">Identificador de la casilla.</param>
        /// <param name="valor">Valor asociado a la casilla.</param>
        public Casilla(string identificador, decimal valor)
        {
