...
{
    /// <summary>
    /// Mapa cuentas contables con las casillas del impuesto de sociedades para el Balance de Situación del Ejercicio 2024.
    /// </summary>
    public class Balance : Mapa
    {
        #region Constructor
        public Balance() : base(TipoModelo.Balance, TipoModalidad.Pymes, datos)
        {
